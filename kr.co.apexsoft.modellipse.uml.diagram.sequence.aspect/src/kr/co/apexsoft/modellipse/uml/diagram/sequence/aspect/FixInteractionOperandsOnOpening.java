...
public class FixInteractionOperandsOnOpening {
	...
	@Around("execution(* org.eclipse.papyrus.uml.diagram.sequence.util.FixInteractionOperandsOnOpening.fix(..))"
			+ " && args(diagram) && target(util)")
	public void calledFix(Diagram diagram, org.eclipse.papyrus.uml.diagram.sequence.util.FixInteractionOperandsOnOpening util) {
